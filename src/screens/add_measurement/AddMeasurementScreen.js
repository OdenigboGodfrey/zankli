...
import {Styles} from './AddMeasurementStyle';
...
export default class AddMeasurementScreen extends Component {
  constructor(props) {
    super(props);
  }
  ...
  render() {
    return (
        <View style={[{flexWrap: 'wrap', padding: 0, borderWidth: 0, width: '100%', height: '100%' }]}>
          ...
          <View style={{flex: 1}}>
            {
              this.state.noMeasurement &&
              <View style={{flex: 1, width: '100%', height: '100%'}}>
                <View style={{alignSelf: 'center',  height: '60%', justifyContent: 'center', padding: 20}}>
                  <Text style={{alignSelf: 'center', width: '100%', fontWeight: 'bold', marginLeft: 10, marginRight: 10, textAlignVertical: 'center'}}>Track your measurements</Text>
                  <Text style={{fontSize: 14, textAlign: 'center', paddingTop: 10}}>Record your body measurements, lab results, vital and more</Text>  
                </View>
