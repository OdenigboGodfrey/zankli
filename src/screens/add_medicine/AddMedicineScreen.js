...
import {Styles} from './AddMedicineStyle';
            ...
            <Content contentContainerStyle={{flex: 1}}>
                <Header>
                    ...
                    <Body style={{alignItems: 'center', flex: 1}}>
                        <Text style={{alignSelf: 'stretch', textAlign: 'center', color: Colours.white, fontSize: 17}}>Add Medicine</Text>
                    </Body>
                    <Right>
                    </Right>
                </Header>
                        ...
                        <View style={{marginTop: 30,backgroundColor: '#fff'}}>
                            <Item 
                                ...
                                <Right>
                                    ...
                                    >
                                        <Picker.Item label={'Panadol'} value={'Panadol'} />
                                        <Picker.Item label={'Piritin'} value={'Piritn'} />
                                        <Picker.Item label={'Kofflin'} value={'Kofflin'} />
                                        <Picker.Item label={'Kofflin'} value={'Kofflin'} />
                                    </Picker>
                                </Right>
                            </Item>
